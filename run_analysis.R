...
#We can use combine the respective data in training and test data sets corresponding to subject, #activity and features. The results are stored insubject, activity and features.
